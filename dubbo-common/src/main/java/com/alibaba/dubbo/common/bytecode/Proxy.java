...
public abstract class Proxy {
    ...
    public static Proxy getProxy(ClassLoader cl, Class<?>... ics) {
        ...
        // 使用拼接后的接口名作为 key
        String key = sb.toString();//结果：com.alibaba.dubbo.demo.DemoService;com.alibaba.dubbo.rpc.service.EchoService;
        ...
        try {
            ...
            ccm = ClassGenerator.newInstance(cl);//实现 Proxy 类的抽象方法
